...
function TicketLookup() {
  ...
  return (
    <div className="rounded-xl border border-neutral-200 bg-white p-5">
      ...
      <p className="mt-1 text-sm text-neutral-500">Paste a ticket ID to inspect its record. Looking up a ticket does not record admission.</p>
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <TicketLookup />
        <p className="rounded-xl border p-5 text-sm">Door access uses event membership and your staff login. The device registry has been removed. Offline scanning and sync are being integrated by the Check-in slice; this lookup does not admit anyone.</p>
      </div>
    </div>
  );
}
