...
CREATE TABLE "events_inventory" (
	...
	"remaining" integer GENERATED ALWAYS AS ("events_inventory"."capacity" - "events_inventory"."reserved" - "events_inventory"."sold") STORED,
	...
	CONSTRAINT "events_inventory_not_oversold" CHECK ("events_inventory"."reserved" + "events_inventory"."sold" <= "events_inventory"."capacity")
);
...
ALTER TABLE "events" ALTER COLUMN "ticket_price" DROP DEFAULT;--> statement-breakpoint
...
ALTER TABLE "tickets" ADD CONSTRAINT "tickets_reservation_id_unique" UNIQUE("reservation_id");